...
\geometry{left=1.4cm, top=.8cm, right=1.4cm, bottom=0.8cm, footskip=0cm}
...
\address{4742 Centre Ave, Pittsburgh, PA, 15213}

\mobile{+1 (608) 698\-6592}
\email{chenfeil@andrew.cmu.edu}
%\dateofbirth{January 1st, 1970}
\homepage{Alexanderia-Mike.github.io} 
% \github{github.com/Alexanderia-Mike}
\linkedin{linkedin.com/in/mike-lou}
% \gitlab{gitlab-id}
